            ...
            <Container component="main" maxWidth="md">
                <div className={classes.paper}>
                    <Alert variant="filled" severity="success">
                        Your password has been reset successfully, now you can <Link style={{ color: 'white' }} to='/'>login again!</Link>
                    </Alert>
                </div>
            </Container>
        );
            ...
            <Container component="main" maxWidth="lg">
                <div className={classes.paper}>
                    <Alert variant="filled" severity="warning">
                        You have used this email to reset your password before, go to <Link variant="body2" to='/passwordreset'>password reset page</Link> and send another email again to reset your password
                </Alert>
                </div>
            </Container>
        );
