  ...
  const getAddressCoordinates = () => {
    fetch(
      "https://maps.googleapis.com/maps/api/geocode/json?address=" +
        ...
        "," +
        props.city +
        "&key=AIzaSyCVuknDu1ZA5Ipp2jnA0cBf5FWL594QI-M"
    )
    ...
    >
      ...
      {selectedPerson && (
        ...
        >
          <div>
            <h2>
              <Link exact to={"/profile/" + selectedPerson.id}>
    ...
    display && (
      <div style={{ width: "100vw", height: "100vh" }}>
        <MapWrapped
          ...
          googleMapURL={
            "https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=AIzaSyCVuknDu1ZA5Ipp2jnA0cBf5FWL594QI-M"
          }
